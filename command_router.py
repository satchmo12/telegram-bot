...
def _feature_for_handler(handler) -> Optional[str]:
    ...
    module_feature_map = [
        ("game_niuniu", "entertainment"),
        ("farm", "game_hub"),
        ("info.economy", "economy"),
        ("info.economy_bank", "economy"),
        ("lottery.betting", "lottery_betting"),
        ("market.price", "market_price"),
        ("company.business", "economy"),
        ("company.company_ipo", "economy"),
        ("company.company_recruit", "economy"),
        ("media.beauty", "entertainment"),
        ("game.checkin", "group"),
        ("game.qa_game", "entertainment"),
        ("game.chengyu_game", "entertainment"),
        ("game.truth_game", "entertainment"),
        ("game.dice_game", "entertainment"),
        ("game.lottery_game", "entertainment"),
        ...
        ("channel.telethon_login", "channel"),
        ("channel.channel_forwarder", "channel"),
        ("channel.reply_to_channel", "channel"),
        ("chat.my_bot", "my_bot"),
        ("slave.slave_game", "game_hub"),
        ("channel.channel_force", "group"),
        ("menu", "group"),
